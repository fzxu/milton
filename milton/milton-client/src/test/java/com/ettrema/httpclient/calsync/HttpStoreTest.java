...
import com.ettrema.httpclient.calsync.store.*;
 ...
 * @author brad
 */
public class HttpStoreTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        Host remoteHost = new Host("127.0.0.1", 8080, "me", "pwd", null);
        remoteStore = new HttpCalendarStore(remoteHost);
